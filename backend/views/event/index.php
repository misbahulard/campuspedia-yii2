                ...
                <div class="box-body">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?= Url::to(Url::base() . '/event/view?id=' . $event->event_id) ?>" class="btn btn-primary"><i class="fa fa-eye"></i></a>
                                <a href="<?= Url::to(Url::base() . '/event/edit?id=' . $event->event_id) ?>" class="btn btn-success"><i class="fa fa-edit"></i></a>
                                <a href="<?= Url::to(Url::base() . '/event/delete?id=' . $event->event_id) ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
